...
import bilstm_template
print("Using bilstm_template from:",bilstm_template.__file__)
# ------------------------------------------------------------------ 
# 1. Paths & constants 
# ------------------------------------------------------------------ 
...
def main(): 
    ...
    plt.plot(C_values, train.mean(axis=1), marker="o", label="Training F1") 
    plt.plot(C_values, val.mean(axis=1), marker="o", label="Validation F1") 
    plt.xscale("log") 
    plt.xlabel("C") 
    plt.ylabel("F1 Score") 
    plt.title("SVM Overfitting Check") 
    plt.legend() 
    plt.tight_layout() 
    plt.savefig(PLOTS_DIR / "svm_overfitting.png") 
    plt.show() 

    print("\nBest SVM C:", C_values[val.mean(axis=1).argmax()]) 
    ...
    plt.figure(figsize=(7, 5)) 
    plt.plot(depth_values, train.mean(axis=1), marker="o", 
             label="Training F1") 
    plt.plot(depth_values, val.mean(axis=1), marker="o", 
             label="Validation F1") 
    ...
    plt.legend() 
    plt.tight_layout() 
    plt.savefig(PLOTS_DIR / "xgboost_overfitting.png") 
    plt.show() 

    print( 
        "\nBest XGBoost max_depth:", 
        depth_values[val.mean(axis=1).argmax()] 
    ) 
