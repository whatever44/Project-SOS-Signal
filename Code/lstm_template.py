...
def load_split(split_name):
    ...
    sequences = {}  # key: hex_id -> {frame_num: array}
    labels = {}     # key: hex_id -> label
    ...
    for label, class_name in enumerate(CLASSES):
        ...
        for fname in os.listdir(folder):
            ...
            # Ensure fixed dimensionality (pad to 126 if necessary)
...
# ---------- 3. Train ----------
# Set up TensorBoard callback with fallback
